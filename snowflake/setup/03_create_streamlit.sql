...
--          @CLAUDE_USAGE_DB.LAYER3.CLAUDE_DASHBOARD_STAGE
...
--
--  アップロード確認:
--    LIST @CLAUDE_USAGE_DB.LAYER3.CLAUDE_DASHBOARD_STAGE;
-- ============================================================================
...
CREATE OR REPLACE STREAMLIT CLAUDE_CODE_USAGE_DASHBOARD
    ROOT_LOCATION = '@CLAUDE_USAGE_DB.LAYER3.CLAUDE_DASHBOARD_STAGE'
...
-- GRANT USAGE ON SCHEMA   CLAUDE_USAGE_DB.LAYER3 TO ROLE <your_role>;
--
-- -- テーブル・ビューの読み取り
-- GRANT SELECT ON ALL TABLES IN SCHEMA CLAUDE_USAGE_DB.LAYER3 TO ROLE <your_role>;
-- GRANT SELECT ON ALL VIEWS  IN SCHEMA CLAUDE_USAGE_DB.LAYER3 TO ROLE <your_role>;
--
-- -- ステージへのアクセス（SiS がファイルを読むために必要）
-- GRANT READ ON STAGE CLAUDE_USAGE_DB.LAYER3.CLAUDE_DASHBOARD_STAGE TO ROLE <your_role>;
--
-- -- ウェアハウスの使用
-- GRANT USAGE ON WAREHOUSE CLAUDE_USAGE_WH TO ROLE <your_role>;
--
-- -- Streamlit アプリの使用
-- GRANT USAGE ON STREAMLIT CLAUDE_USAGE_DB.LAYER3.CLAUDE_CODE_USAGE_DASHBOARD TO ROLE <your_role>;
...
-- 6. SiS アプリの確認
-- ============================================================================
SHOW STREAMLITS IN SCHEMA CLAUDE_USAGE_DB.LAYER3;
